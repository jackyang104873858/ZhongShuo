	...
	var e = function() {
			...
			function() {
				...
				if (window.console = r, window._console = o, window.localStorage && window.__DEBUGINFO) {
					var c = e("DEBUG_SWITCH"),
						l = window.__DEBUGINFO;
					...
					var i = [];
					"undefined" != typeof t && i.push("line : " + t), "undefined" != typeof n && i.push("col : " + n), i.length > 0 && r.error(i.join(", "));
				});
			}(), function() {
				function e(e) {
				...
				function i(e) {
					...
					o && (o.open("POST", location.protocol + "//mp.weixin.qq.com/mp/jsmonitor?", !0), o.setRequestHeader("cache-control", "no-cache"), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.send(e));
				}
				...
				var l, u, d, f, w, m, p = /MicroMessenger/i.test(navigator.userAgent),
					_ = window.define,
					h = 0,
					v = 2,
					g = 4,
				...
				if (window.__initCatch = function(e) {
					...
					if (/mp\.weixin\.qq\.com/.test(location.href) && !(Math.random() > .5) && p && top == window && (t(o) && (o = [o]), e(o) && "" != l)) {
						var r = "",
							a = [],
							s = [],
							c = [],
				...
				}, window.setTimeout = a(window.setTimeout), window.setInterval = a(window.setInterval), Math.random() < .01 && window.Document && window.HTMLElement) {
					var E = {},
						D = 0;
				...
				if ((/ip(hone|ad|od)/i.test(j) || /android/i.test(j)) && !/windows phone/i.test(j) && window.localStorage && window.localStorage.setItem) {
					var I = window.localStorage.setItem,
						L = 0;
					...
					for (var e, o = [], t = arguments && arguments[0], n = 0, i = arguments.length; i > n; n++) {
						...
						"function" == typeof e && (e = function() {
							try {
								...
								throw "string" == typeof t && console.error("[TryCatch][DefineeErr]id:" + t), e.stack && console && console.error && console.error("[TryCatch]" + e.stack), l && window.__moon_report && (window.__moon_report([{
									offset: h,
				...
				function o(e, o, t) {
					return window.__DEBUGINFO ? (window.__DEBUGINFO.res_list || (window.__DEBUGINFO.res_list = []), window.__DEBUGINFO.res_list[e] ? (window.__DEBUGINFO.res_list[e][o] = t, !0) : !1) : !1;
				}
				...
				function t(e, o, t) {
					if ("object" == typeof e) {
						...
						if (t = t || e, "Array" == r) {
							...
							for (var i in e) {
								if (e.hasOwnProperty(i) && o.call(t, e[i], i, e) === !1) 
									return;
							}
						}
					}
				...
				var n = e.localStorage,
					...
					s = {
						...
						init: function() {
							...
							var o, r, i;
							if (n) {
								var a = "_moon_ver_key_",
									c = n.getItem(a);
								c != s.version && (s.clear(), n.setItem(a, s.version));
							}
							if (-1 != location.search.indexOf("no_moon1=1") && s.clear(), n) {
								var l = 1 * n.getItem(s.prefix + "clean_time"),
									u = +new Date;
								if (u - l >= 1296e6) {
									s.clear();
									try { !! n && n.setItem(s.prefix + "clean_time", +new Date);
									} catch (d) {}
								}
							}
							t(moon_map, function(t, a) {
								if (r = s.prefix + a, i = !! t && t.replace(/^http(s)?:\/\/res.wx.qq.com/, ""), o = !! n && n.getItem(r), version = !! n && (n.getItem(r + "_ver") || "").replace(/^http(s)?:\/\/res.wx.qq.com/, ""), s.mod_num++, o /*&& i == version*/) try {
									var c = "//# sourceURL=" + a + "\n//@ sourceURL=" + a;
						...
						genUrl: function() {
							...
							var o, t, n = "",
								...
								c = "//localhost:1337/js/comment/"; - 1 != location.href.indexOf("moon_debug2=1") && (c = "//mp.weixin.qq.com");
							for(var l=0,u=e.length;u>l;++l)/^\/(.*?)\//.test(e[l]),RegExp.$1&&(t=RegExp.$1,n=i[t],
							n ? (o = n + "," + e[l], o.length > 1e3 || a ? (r.push(n + "?v=" + s.version), n = location.protocol + c + e[l], i[t] = n) : (n = o, i[t] = n)) : (n = location.protocol + c + e[l], i[t] = n));
					...
					load: function(e) {
						...
						if (e) {
							...
							if(urls.length > 0) {
								for(var index = 0; index < urls.length; index++) {
									...
									c.src = url, c.type = "text/javascript", c.async = !0, c.onerror = function(n) {
										if (o(a, "status", "error"), o(a, "end", +new Date), t >= 0) s.request(url, t);
										else if (window.__moon_report) {
											var r = new Error(n);
									...
									}, "undefined" != typeof moon_crossorigin && moon_crossorigin && c.setAttribute("crossorigin", !0), c.onload = c.onreadystatechange = function() {
										o(a, "status", "loaded"), o(a, "end", +new Date), !c || c.readyState && !/loaded|complete/.test(c.readyState) || (o(a, "status", "200"), c.onload = c.onreadystatechange = null, "function" == typeof n && n());
									}, t--, r.appendChild(c);
								}
							}
						}
						...
						n && (t(n, function(e, o) {~o.indexOf(s.prefix) && n.removeItem(o);
